...
number_of_trees = apple_tree + pear_tree + plum_tree
...
print("Temperature in the evening:", evening_temp, "°C")
...
girls_today = girls - 2
boys_today = boys -1
kids_today = girls_today + boys_today
print("Kids in the group today:", kids_today)
...
print("Total books price:", total, "UAH")
